...
(test-eq #f (cfun-conversion-exception? #f))
(test-eq #f (sfun-conversion-exception? #f))
(test-eq #f (rpc-remote-error-exception? #f))
(test-eq #f (scheduler-exception? #f))
(test-eq #f (number-of-arguments-limit-exception? #f))
...
(test-assert (procedure? cfun-conversion-exception?))
(test-assert (procedure? sfun-conversion-exception?))
(test-assert (procedure? rpc-remote-error-exception?))
(test-assert (procedure? scheduler-exception?))
(test-assert (procedure? number-of-arguments-limit-exception?))

(test-error-tail type-exception? (cfun-conversion-exception-arguments #f))
(test-error-tail type-exception? (cfun-conversion-exception-code #f))
(test-error-tail type-exception? (cfun-conversion-exception-message #f))
(test-error-tail type-exception? (cfun-conversion-exception-procedure #f))
(test-error-tail type-exception? (sfun-conversion-exception-arguments #f))
(test-error-tail type-exception? (sfun-conversion-exception-code #f))
(test-error-tail type-exception? (sfun-conversion-exception-message #f))
(test-error-tail type-exception? (sfun-conversion-exception-procedure #f))
(test-error-tail type-exception? (rpc-remote-error-exception-arguments #f))
(test-error-tail type-exception? (rpc-remote-error-exception-message #f))
(test-error-tail type-exception? (rpc-remote-error-exception-procedure #f))
